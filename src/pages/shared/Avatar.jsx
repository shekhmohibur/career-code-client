...
const Avatar = () => {
  ...
  const handleClickOutside = (e) => {
    if (avatarRef.current && !avatarRef.current.contains(e.target) && toggleAvatar) {
  ...
  return (
    <div className="relative z-50 group">
      ...
      <div ref={avatarRef} className={`mt-3 flex-col items-start gap-1 absolute flex bg-blue-50 shadow w-32 ${toggleAvatar ? '' : 'hidden'}`} >
